...
\yii\widgets\Pjax::begin(['id'=>'cart','timeout'=>5000,'options'=>['data-uk-observe'=>true,'scrollTo'=>false,'class'=>'cart']]); ?>
...
<?php else: ?>
    ...
    <table class="cart uk-table uk-table-hover uk-table-condensed">
        <thead>
        <tr>
            <th>Изображение</th>
            <th>Наименование</th>
